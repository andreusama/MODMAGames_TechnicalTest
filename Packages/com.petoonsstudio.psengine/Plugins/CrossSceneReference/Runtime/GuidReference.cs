...
namespace CrossSceneReference
{
    ...
    public class GuidReference : ISerializationCallbackReceiver
    {
        ...
        {
            get { return serializedGuid; }
            set { serializedGuid = value; guid = new Guid(serializedGuid); }
        }
        ...
        public SceneAsset CachedScene
        {
            get { return cachedScene; }
            set { cachedScene = value; }
        }
#endif
        ...
        public bool TryGetComponent<T>(out T component) where T : Component
        {
            ...
            if (gameObject != null && gameObject.TryGetComponent<T>(out component))
                return true;
            else
                return false;
        }
