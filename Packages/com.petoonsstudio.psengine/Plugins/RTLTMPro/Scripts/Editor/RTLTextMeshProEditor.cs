...
namespace RTLTMPro
{
    ...
    public class RTLTextMeshProEditor : TMP_UiEditorPanel
    {
        ...
        private SerializedProperty fixAlignmentProp; // Petoons modification
        ...
        private new void OnEnable()
        {
            ...
            fixAlignmentProp = serializedObject.FindProperty("fixAlignment"); // Petoons modification
        }
        ...
        protected virtual void DrawOptions()
        {
            ...
            fixAlignmentProp.boolValue = GUILayout.Toggle(fixAlignmentProp.boolValue, new GUIContent("Fix Alignment")); // Petoons modification
