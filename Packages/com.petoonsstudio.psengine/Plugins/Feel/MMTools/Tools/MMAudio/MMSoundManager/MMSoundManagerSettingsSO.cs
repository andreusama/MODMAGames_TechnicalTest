...
namespace MoreMountains.Tools
{
    ...
    public class MMSoundManagerSettingsSO : ScriptableObject
    {
        ...
        /// the group on which to play all Voices sounds
        [Tooltip("the group on which to play all voices sounds")]
        ...
        public virtual void LoadSettings(MMSoundManagerSettings settings)
        {
            if (settings != null)
            {
        ...
        public virtual void SetTrackVolume(MMSoundManager.MMSoundManagerTracks track, float volume)
        {
            ...
            switch (track)
            {
                ...
                case MMSoundManager.MMSoundManagerTracks.Voices:
                    TargetAudioMixer.SetFloat(Settings.VoicesVolumeParameter, NormalizedToMixerVolume(volume));
                    Settings.VoicesVolume = volume;
                    break;
            }
        }
        ...
        public virtual float GetTrackVolume(MMSoundManager.MMSoundManagerTracks track)
        {
            ...
            switch (track)
            {
                ...
                case MMSoundManager.MMSoundManagerTracks.UI:
                    ...
                    break;
                case MMSoundManager.MMSoundManagerTracks.Voices:
                    TargetAudioMixer.GetFloat(Settings.VoicesVolumeParameter, out volume);
                    break;
            }
        ...
        public virtual void GetTrackVolumes()
        {
            ...
            Settings.VoicesVolume = GetTrackVolume(MMSoundManager.MMSoundManagerTracks.Voices);
        }
        ...
        protected virtual void ApplyTrackVolumes()
        {
            if (Settings.OverrideMixerSettings)
            {
                ...
                TargetAudioMixer.SetFloat(Settings.VoicesVolumeParameter, NormalizedToMixerVolume(Settings.VoicesVolume));
                ...
                if (!Settings.VoicesOn) { TargetAudioMixer.SetFloat(Settings.VoicesVolumeParameter, -80f); }
            }
        }
