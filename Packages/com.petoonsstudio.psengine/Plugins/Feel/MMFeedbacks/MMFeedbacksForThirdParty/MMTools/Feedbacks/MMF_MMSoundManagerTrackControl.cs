...
namespace MoreMountains.Feedbacks
{
	...
	public class MMF_MMSoundManagerTrackControl : MMF_Feedback
	{
		...
		public enum ControlModes { Mute, UnMute, SetVolume, Pause, UnPause, Play, Stop, Free }
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			switch (ControlMode)
			{
				...
				case ControlModes.Pause:
					...
					break;
                case ControlModes.UnPause:
                    MMSoundManagerTrackEvent.Trigger(MMSoundManagerTrackEventTypes.UnPauseTrack, Track);
                    break;
