...
namespace MoreMountains.Feedbacks
{
	...
	public class MMF_ImageTextureOffset : MMF_Feedback
	{
		...
		protected override void CustomInitialization(MMF_Player owner)
		{
			...
			switch (MaterialPropertyType)
			{
				case MaterialPropertyTypes.Main:
					_initialValue = TargetImage.materialForRendering.mainTextureOffset;
					break;
				case MaterialPropertyTypes.TextureID:
					_initialValue = TargetImage.materialForRendering.GetTextureOffset(MaterialPropertyName);
					break;
			}
		}
		...
		protected virtual void ApplyValue(Vector2 newValue)
		{
			...
			{
				case MaterialPropertyTypes.Main:
                    TargetImage.materialForRendering.mainTextureOffset = newValue;
					break;
				case MaterialPropertyTypes.TextureID:
                    TargetImage.materialForRendering.SetTextureOffset(MaterialPropertyName, newValue);
					break;
			}
		}
