// GENERATED AUTOMATICALLY FROM 'Assets/Samples/Game Core/0.4.1-preview/Leaderboards/LeaderboardsInputManager.inputactions'
...
{
    public class @LeaderboardsInputManager : IInputActionCollection, IDisposable
    {
        public InputActionAsset asset { get; }
        public @LeaderboardsInputManager()
        {
            asset = InputActionAsset.FromJson(@"{
    ""name"": ""LeaderboardsInputManager"",
    ""maps"": [
        {
            ""name"": ""UI"",
    ...
    ""controlSchemes"": [
        ...
        {
            private @LeaderboardsInputManager m_Wrapper;
            public UIActions(@LeaderboardsInputManager wrapper) { m_Wrapper = wrapper; }
