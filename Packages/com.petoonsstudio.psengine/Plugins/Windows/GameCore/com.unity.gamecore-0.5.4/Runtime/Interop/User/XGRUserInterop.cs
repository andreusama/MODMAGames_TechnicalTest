...
namespace Unity.GameCore.Interop
{
    ...
    partial class XGRInterop
    {
        ...
        //    ) noexcept;
        [DllImport(ThunkDllName, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 XUserAddByIdWithUiAsync(UInt64 userId, XAsyncBlockPtr asyncBlock);
        ...
        //) noexcept;
        [DllImport(ThunkDllName, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 XUserAddByIdWithUiResult(XAsyncBlockPtr asyncBlock, out XUserHandle newUser);
        ...
        //    ) noexcept;
        [DllImport(ThunkDllName, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 XUserFindControllerForUserWithUiAsync(XUserHandle handle, XAsyncBlockPtr async);
        ...
        //) noexcept;
        [DllImport(ThunkDllName, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 XUserFindControllerForUserWithUiResult(XAsyncBlockPtr async, Byte[] deviceId);
    }
}
