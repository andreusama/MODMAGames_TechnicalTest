...
namespace PetoonsStudio.PSEngine.Utils
{
    ...
    public class MonoScriptAttributePropertyDrawer : PropertyDrawer
    {
        static Dictionary<string, MonoScript> m_ScriptCache;
        static MonoScriptAttributePropertyDrawer()
        {
            ...
            if (property.propertyType == SerializedPropertyType.String)
            {
                ...
                if (GUI.changed)
                {
                    if (script != null)
                    {
                        ...
                        if ((attr.type != null && !attr.type.IsAssignableFrom(type)) || !(attr.type == type))
                            type = null;
                        if (type != null)
