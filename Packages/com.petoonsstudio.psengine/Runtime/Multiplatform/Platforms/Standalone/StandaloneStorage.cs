...
namespace PetoonsStudio.PSEngine.Multiplatform
{
    public class StandaloneStorage : IStorage
    {
        ...
        {
            DeleteSaveStandalone(fileName, folderName);
        ...
        {
            return Task.FromResult(LoadStandalone<T>(fileName, folderName));
        }

        public Task<bool> Save(object saveObject, string fileName, string folderName)
        {
            return Task.FromResult(SaveStandalone(saveObject, fileName, folderName));
        }

        public Task<bool> SaveExists(string fileName, string folderName)
        {
            return Task.FromResult(SaveExistsStandalone(fileName, folderName));
        }
        ...
        public static void DeleteSaveStandalone(string fileName, string folderName)
        {
        ...
        /// <param name="folderName"></param>
        /// <returns></returns>
        public static bool SaveExistsStandalone(string saveName, string folderName)
        {
            string savePath = DetermineSavePath(folderName);
        ...
        /// Save standalone
        /// </summary>
        public static bool SaveStandalone(object saveObject, string fileName, string folderName)
        {
            string savePath = DetermineSavePath(folderName);
            string saveFileName = fileName;
        ...
        /// <param name="folderName"></param>
        /// <returns></returns>
        public static T LoadStandalone<T>(string fileName, string folderName)
        {
            string savePath = DetermineSavePath(folderName);
