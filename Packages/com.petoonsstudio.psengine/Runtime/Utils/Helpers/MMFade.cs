...
namespace PetoonsStudio.PSEngine.Utils
{
    ...
    public static class MMFade
    {
        ...
        /// <param name="opacity">Opacity.</param>
        /// <param name="duration">Duration.</param>
        public static IEnumerator FadeText(TextMeshPro target, float duration, Color color)
        {
            if (target == null)
                yield break;
        ...
        /// <summary>
        /// Fades the specified sprite color to the target opacity and duration.
        /// </summary>
        /// <param name="target">Target.</param>
        /// <param name="opacity">Opacity.</param>
        /// <param name="duration">Duration.</param>
        public static IEnumerator FadeSpriteColor(SpriteRenderer target, float duration, Color color)
        {
            if (target == null)
                yield break;
