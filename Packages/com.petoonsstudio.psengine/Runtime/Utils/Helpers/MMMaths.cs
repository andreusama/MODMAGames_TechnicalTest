...
namespace PetoonsStudio.PSEngine.Utils
{
    ...
    public static class MMMaths
    {
        ...
        /// <summary>
        /// Applies the SmoothStep function to Vectors.
        /// </summary>
        /// <param name="from">Starting Vector</param>
        /// <param name="to">Final Vector</param>
        /// <param name="t">Time fraction</param>
        ...
        {
            Vector2 vector;
            float tmp = Mathf.Round(Mathf.Cos(Angle * Mathf.PI / 180) * 10000);
            vector.x = tmp / 10000;
            tmp = Mathf.Round(Mathf.Sin(Angle * Mathf.PI / 180) * 10000);
            vector.y = tmp / 10000;
            vector.Normalize();
            return vector;
        }
        ...
        /// <summary>
        /// Round a value to one of the possible values given
        /// </summary>
        ...
        /// <summary>
        /// Project a parabola 2D line over time
        /// </summary>
        ...
        public static bool Approximately(Vector3 lhs, Vector3 rhs, float tolerance = 0.001f * 0.001f)
        {
            return Vector3.SqrMagnitude(lhs - rhs) < tolerance;
        }

        /// <summary>
        /// Same as <c>Mathf.PingPong</c> but with custom min and max values.
        /// </summary>
        /// <param name="t">Current value to be ping-ponged.</param>
        /// <param name="minValue">Minimum allowed value</param>
        /// <param name="maxValue">Maximum allowed value</param>
        /// <returns>Ping-ponged value</returns>
        public static float PingPong(float t, float minValue, float maxValue)
        {
            return minValue + Mathf.PingPong(t - minValue, maxValue - minValue);
        }

        /// <summary>
        /// Calculates the volume of a capsule.
        /// Based on: https://www.calculatorsoup.com/calculators/geometry-solids/capsule.php
        /// </summary>
        /// <param name="radius">Radius of the capsule</param>
        /// <param name="height">Height of the capsule, from top to bottom (and viceversa).</param>
        /// <returns>Volume of the capsule</returns>
        public static float CalculateCapsuleVolume(float radius, float height)
        {
            float a = Mathf.Max(height - (radius * 2f), radius);
            return Mathf.PI * Mathf.Pow(radius, 2) * (((4f / 3f) * radius) + a);
        }
    }
}